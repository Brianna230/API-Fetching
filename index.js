...
async function initialLoad() {
  const listsOfBreed = await fetch(
    "http://api.thecatapi.com/v1/breeds?api_key=live_8UaLuIIW2nk6xoNn8bv1iLb2XWYf0A0tm765eNkeYDaDErWjzYpm8mNZMsTIKU5l"
  );
  const lists = await listsOfBreed.json();
  // console.log(lists);
  const breedSelect = document.querySelector("#breedSelect");
  for (let breed of lists) {
